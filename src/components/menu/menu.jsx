...
const Menu = () => {
  ...
  const menuData = {
    mains: {
      title: "Mains",
      color: "bg-red-600 text-yellow-100",
      items: [
    ...
    starters: {
      title: "Starters",
      color: "bg-green-600 text-yellow-100",
      items: [
...
<div className="min-h-screen bg-yellow-50 flex flex-col">
  ...
  {/* Category Banner */}
  <div className={`${menuData[activeCategory].color} py-12 text-center`}>
    <h2 className="text-5xl md:text-7xl font-black font-headline mb-2">
      {menuData[activeCategory].title}
    </h2>
    <p className="text-xl">Authentic Mexican Flavors Made Fresh</p>
  </div>
        ...
        <button
          ...
          className={`px-6 py-3 rounded-xl text-lg font-bold border-2 transition-all duration-300 ${
            activeCategory === cat.id
              ? "bg-green-600 text-yellow-100 border-green-800 scale-105 shadow-lg"
